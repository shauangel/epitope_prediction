...
function more_set(){
    ...
    var mes="<tbody>";
    mes+='<tr><td>threshold</td><td><input type="range" min="0" max="100" value="'+select_range[0]+'" class="Slider" id="select0"></input></td><td id="show0">'+select_range[0]/100+'</td></tr>'
        +'<tr><td>LEPS</td><td><input type="range" min="0" max="100" value="'+select_range[1]+'" class="Slider" id="select1"></input></td><td id="show1">'+select_range[1]/100+'</td></tr>'
        +'<tr><td>BCpreds</td><td><input type="range" min="0" max="100" value="'+select_range[2]+'" class="Slider" id="select2"></input></td><td id="show2">'+select_range[2]/100+'</td></tr>'
        +'<tr><td>BepiPred-2</td><td><input type="range" min="0" max="100" value="'+select_range[3]+'" class="Slider" id="select3"></input></td><td id="show3">'+select_range[3]/100+'</td></tr>'
        +'<tr><td>ABCPred</td><td><input type="range" min="0" max="100" value="'+select_range[4]+'" class="Slider" id="select4"></input></td><td id="show4">'+select_range[4]/100+'</td></tr>'
        +'<tr><td>Bcepred</td><td><input type="range" min="0" max="100" value="'+select_range[5]+'" class="Slider" id="select5"></input></td><td id="show5">'+select_range[5]/100+'</td></tr>'
        +'<tr><td>LBtope</td><td><input type="range" min="0" max="100" value="'+select_range[6]+'" class="Slider" id="select6"></input></td><td id="show6">'+select_range[6]/100+'</td></tr>'
        +'<tr><td>Minimum length</td><td><input type="range" min="1" max="20" value="'+textlong+'" class="Slidert" id="textlong"></input></td><td id="tl">'+textlong+'</td></tr><tbody>';
    left.innerHTML = mes;
    ...
    document.getElementById("select6").oninput=function(){
        select_range[6]=parseInt(this.value);
        document.getElementById("show6").innerHTML=select_range[6]/100;
    }
